    ...
    return (
       <Fragment>
            <Accordion as="ul" className="navbar-nav iq-main-menu">
                ...
                <li className={`${location.pathname === '/superadmin' ? 'active' : ''} nav-item `}>
                    <Link className={`${location.pathname === '/superadmin  ' ? 'active' : ''} nav-link `} aria-current="page" to="/superadmin" onClick={() => {}}>
                        <i className="icon">
                ...
                <CustomToggle eventKey="sidebar-special" onClick={(activeKey) => setActiveMenu(activeKey)}>
                    ...
                    <Accordion.Collapse eventKey="sidebar-special" >
                        <ul className="sub-nav">
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/superadmin/dashboard/special-pages/billing' ? 'active' : ''} nav-link`} to="/superadmin/dashboard/special-pages/billing">
                                <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/superadmin/dashboard/special-pages/kanban' ? 'active' : '' } nav-link`} to="/superadmin/dashboard/special-pages/kanban">
                                    <i className="icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/superadmin/dashboard/special-pages/pricing' ? 'active' : ''} nav-link`} to="/superadmin/dashboard/special-pages/pricing">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                            <Link className={`${location.pathname === '/superadmin/dashboard/special-pages/rtl-support' ? 'active' : ''} nav-link`} to="/superadmin/dashboard/special-pages/rtl-support">
                                <i className="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/superadmin/dashboard/special-pages/timeline' ? 'active' : ''} nav-link`} to="/superadmin/dashboard/special-pages/timeline">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                ...
                <Accordion.Item as="li" eventKey="sidebar-user" bsPrefix={`nav-item ${active === 'user' ? 'active' : ''} `} onClick={() => setActive('user')}>
                    ...
                    <Accordion.Collapse eventKey="sidebar-user">
                        <ul className="sub-nav">
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/superadmin/dashboard/app/user-profile' ? 'active' : ''} nav-link`} to="/superadmin/dashboard/app/user-profile">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/superadmin/dashboard/app/user-add' ? 'active' : ''} nav-link`} to="/superadmin/dashboard/app/user-add">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/superadmin/dashboard/app/user-list' ? 'active' : ''} nav-link`} to="/superadmin/dashboard/app/user-list">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                ...
                <li className="nav-item">
                <Link className={`${location.pathname === '/superadmin/dashboard/admin/admin' ? 'active' : ''} nav-link`} to="/superadmin/dashboard/admin/admin">
                        <i className="icon">
                            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
