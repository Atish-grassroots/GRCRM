    ...
    return (
       <Fragment>
            <Accordion as="ul" className="navbar-nav iq-main-menu">
                ...
                <li className={`${location.pathname === '/manager' ? 'active' : ''} nav-item `}>
                    <Link className={`${location.pathname === '/manager  ' ? 'active' : ''} nav-link `} aria-current="page" to="/manager" onClick={() => {}}>
                        <i className="icon">
                ...
                <Accordion.Item as="li" eventKey="sidebar-widget" bsPrefix={` ${location.pathname === '/dashboard/widget/widgetbasic' || location.pathname === '/dashboard/widget/widgetchart' || location.pathname === '/dashboard/widget/widgetcard' ? 'active' : '' || active === 'widget' ? 'active' : ''} nav-item`} onClick={() => setActive('widget')}>
                    ...
                    <Accordion.Collapse eventKey="sidebar-widget">
                        <ul className="sub-nav">
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/manager/dashboard/widget/widgetbasic' ? 'active' : ''} nav-link`} to="/manager/dashboard/widget/widgetbasic">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/manager/dashboard/widget/widgetchart' ? 'active' : ''} nav-link`} to="/manager/dashboard/widget/widgetchart">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/manager/dashboard/widget/widgetcard' ? 'active' : ''} nav-link`} to="/manager/dashboard/widget/widgetcard">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                ...
                <CustomToggle eventKey="sidebar-maps" active={activeMenu === 'sidebar-maps' ? true : false} onClick={(activeKey) => setActiveMenu(activeKey)}>
                    ...
                    <Accordion.Collapse eventKey="sidebar-maps">
                        <ul className="sub-nav">
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/manager/dashboard/map/google' ? 'active' : ''} nav-link`} to="/manager/dashboard/map/google">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/manager/dashboard/map/vector' ? 'active' : ''} nav-link`} to="/manager/dashboard/map/vector">
                                <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                ...
                <Accordion.Item as="li" eventKey="sidebar-form" bsPrefix={`nav-item ${active === 'form' ? 'active' : ''} `} onClick={() => setActive('form')}>
                 <CustomToggle eventKey="sidebar-form" active={activeMenu === 'sidebar-form' ? true : false} onClick={(activeKey) => setActiveMenu(activeKey)}>
                    ...
                    <Accordion.Collapse eventKey="sidebar-form" >
                        <ul className="sub-nav">
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/manager/dashboard/form/form-element' ? 'active' : ''} nav-link`} to="/manager/dashboard/form/form-element">
                                <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/manager/dashboard/form/form-wizard' ? 'active' : ''} nav-link`} to="/manager/dashboard/form/form-wizard">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/manager/dashboard/form/form-validation' ? 'active' : ''} nav-link`} to="/manager/dashboard/form/form-validation">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                ...
                <Accordion.Item as="li" eventKey="sidebar-table" bsPrefix={`nav-item ${active === 'table' ? 'active' : ''} `} onClick={() => setActive('table')}>
                 <CustomToggle eventKey="sidebar-table" onClick={(activeKey) => setActiveMenu(activeKey)}>
                    ...
                    <Accordion.Collapse eventKey="sidebar-table">
                        <ul className="sub-nav">
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/manager/dashboard/table/bootstrap-table' ? 'active' :''} nav-link`} to="/manager/dashboard/table/bootstrap-table">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/manager/dashboard/table/table-data' ? 'active' : ''} nav-link`} to="/manager/dashboard/table/table-data">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                ...
                <CustomToggle eventKey="sidebar-icons" onClick={(activeKey) => setActiveMenu(activeKey)}>
                    ...
                    <Accordion.Collapse eventKey="sidebar-icons">
                        <ul className="sub-nav">
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/manager/dashboard/icon/solid' ? 'active' : ''} nav-link`} to="/manager/dashboard/icon/solid">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/manager/dashboard/icon/outline' ? 'active' : ''} nav-link`} to="/manager/dashboard/icon/outline">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/manager/dashboard/icon/dual-tone' ? 'active' : ''} nav-link`} to="/manager/dashboard/icon/dual-tone">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
